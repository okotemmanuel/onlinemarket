...
echo '<br><li style="margin-top:-20px;"><a  href="onlinemarketin.php">'.'<u >HOME</u>'.'</a></li>';	
  ...
  if (mysqli_num_rows($results) > 0) {
	...
	echo    '<li style="margin-top:-20px;">'.'<a href="onlinemarketin.php?idt='.$idtw.'&idtt='.$idts.'">'.$catr.'</a>'.'</li>';
